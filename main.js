...
ScrollReveal().reveal('.python-lst', { delay: 0, origin: 'left' });
ScrollReveal().reveal('.js-lst', { delay: 50, origin: 'left' });
ScrollReveal().reveal('.react-lst', { delay: 100, origin: 'left' });
ScrollReveal().reveal('.node-lst', { delay: 150, origin: 'left' });
ScrollReveal().reveal('.java-lst', { delay: 200, origin: 'left' });
ScrollReveal().reveal('.aws-lst', { delay: 250, origin: 'left' });
ScrollReveal().reveal('.flutter-lst', { delay: 300, origin: 'left' });
